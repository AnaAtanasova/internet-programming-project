...
<div class="col-sm-2" style="background-color:#872822; height:400px;"></div>
<div class="col-sm-4" style="height:400px;">
<br><br><br><br><br>
<div class = "shadow p-3 mb-5 bg-white rounded" style="background-color:white">
<h3 style="color:#cfc491">Недостапно</h3>
<br>
<h3 style="color:#b8b8b8;font-size:20;">Логирај се за пристап <a href="login.php" class="btn btn-info" role="button">LOG IN</a></h3></div>
</div>
<div class="col-sm-4" style=" height:400px;">
<img src="slika13.png" height="370" width="500">
</div>
</div>
