...
<h2 style="color:#8a8a8a"><center>Ажурираната анкета:</center></h2>
</div></div>
<div class="col-sm-1" style="background-color:white;height:150px;"></div>
<div class="col-sm-2" style="background-color:#872822; height:150px;"></div>
</div>
...
<br>
<h3 style="color:#cfc491">Податоци за анкетата:
<?php
...
<br>
<a href="dodadiPrasanje.php" class="btn btn-info" role="button">Назад</a>
</div>
...
$sql2="SELECT vid FROM prasanja AS p, anketi AS a, anketaprasanja AS ap
      WHERE p.id_prasanje=ap.id_prasanje and ap.id_anketa='$idAnketa'";
