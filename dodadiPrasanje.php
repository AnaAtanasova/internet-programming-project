...
<h2 style="color:#8a8a8a"><center>Додади прашање</center></h2>
</div></div>
...
<h3 style="color:#cfc491">Додади прашање</h3>
<br>
...
<div class="col-sm-6" style="background-color:white; height:80px;"><a href="povekeinf.php" class="btn btn-info" role="button">Назад</a>
...
if(isset($_POST['b6']))
{
 echo "<script type='text/javascript'>
           window.location = 'anketaUpdated.php'
      </script>"; }
if(isset($_POST['b4']))
{
